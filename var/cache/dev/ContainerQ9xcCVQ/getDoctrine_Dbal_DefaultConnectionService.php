...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_sqlsrv', 'host' => 'THEO-SURFACE\\SQLEXPRESS', 'port' => 1433, 'dbname' => 'MegaCastings', 'user' => 'sa', 'password' => 'not24get', 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
    }
}
