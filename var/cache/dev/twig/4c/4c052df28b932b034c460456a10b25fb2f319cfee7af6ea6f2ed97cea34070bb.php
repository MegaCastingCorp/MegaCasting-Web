...
class __TwigTemplate_ccbf8f14d1bffa12389e01c8cc667b6ebf570b83b4cbc796731e009f851bc11b extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container d-flex justify-content-around flex-wrap mt-3 mb-3\">  
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable($context["offers"]);
        foreach ($context['_seq'] as $context["_key"] => $context["offers"]) {
            ...
            <div id=\"Film\" class=\"card-body\">
                <h5 class=\"card-title\">";
            // line 75
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["offers"], "name", [], "any", false, false, false, 75), "html", null, true);
            echo "</h5>
...
";
    ...
    {
        return array (  183 => 107,  175 => 101,  172 => 81,  160 => 75,  155 => 73,  152 => 72,  148 => 71,  107 => 33,  88 => 17,  76 => 8,  73 => 7,  66 => 6,  53 => 3,  36 => 1,);
    }
  ...
  <div class=\"container d-flex justify-content-around flex-wrap mt-3 mb-3\">  
    ...
    {% for offers in offers %}
        <div class=\"card\" style=\"width: 18rem;\">
            ...
            <div id=\"Film\" class=\"card-body\">
                <h5 class=\"card-title\">{{ offers.name }}</h5>
                <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href=\"#\" class=\"btn btn-postuler\">Postuler</a>
            </div>
        </div>
...
{% endblock %}
", "casting/index.html.twig", "C:\\Users\\tete-\\Desktop\\MegaCasting\\MegaCasting-Symfo\\templates\\casting\\index.html.twig");
    }
}
