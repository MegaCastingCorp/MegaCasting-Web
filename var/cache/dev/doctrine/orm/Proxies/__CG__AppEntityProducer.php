 ...
 */
class Producer extends \App\Entity\Producer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Producer' . "\0" . 'identifier', '' . "\0" . 'App\\Entity\\Producer' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Producer' . "\0" . 'username', '' . "\0" . 'App\\Entity\\Producer' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Producer' . "\0" . 'url', '' . "\0" . 'App\\Entity\\Producer' . "\0" . 'identifierpack'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Producer $proxy) {
