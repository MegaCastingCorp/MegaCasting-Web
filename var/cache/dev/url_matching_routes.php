...
return [
    ...
    [ // $staticRoutes
        ...
        '/phpinfo' => [[['_route' => 'phpinfo', '_controller' => 'App\\Controller\\HomeController::phpinfo'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        57 => [
            [['_route' => 'showoffer', '_controller' => 'App\\Controller\\OfferController::showoffer'], ['id'], null, null, false, true, null],
